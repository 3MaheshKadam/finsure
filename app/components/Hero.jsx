...
const HeroSection = () => {
  ...
  const loanTypes = [
    { icon: Users, name: 'Personal Loan', color: '#4248f8', delay: 0 },
    { icon: Building2, name: 'Business Loan', color: '#06b6d4', delay: 1 },
    { icon: Home, name: 'Home Loan', color: '#10b981', delay: 2 },
    { icon: Car, name: 'Car Loan', color: '#f59e0b', delay: 3 }
  ];
              ...
              <div className="w-full max-w-lg mx-auto">
                ...
                <div className="bg-white rounded-2xl p-6 shadow-xl border border-gray-100">
                  ...
                  >
                    ...
                    {loanTypes.map((loan, index) => {
                      const positions = [
                        { x: 120, y: 80 },   // Personal - top left
                        { x: 280, y: 80 },   // Business - top right  
                        { x: 120, y: 220 },  // Home - bottom left
                        { x: 280, y: 220 }   // Car - bottom right
                      ];
                      ...
                      return (
                        <g key={index}>
                          ...
                          {index === 0 && ( // Personal
                            <g>
                              <circle cx={pos.x} cy={pos.y-5} r="5" fill={isActive ? 'white' : '#6b7280'} />
                              <path
                                d={`M${pos.x-8},${pos.y+8} Q${pos.x-8},${pos.y+2} ${pos.x-5},${pos.y+2} L${pos.x-5},${pos.y+8} Z M${pos.x+5},${pos.y+2} Q${pos.x+8},${pos.y+2} ${pos.x+8},${pos.y+8} L${pos.x+5},${pos.y+8} Z`}
                                fill={isActive ? 'white' : '#6b7280'}
                              />
                            </g>
                          )}
