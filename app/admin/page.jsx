...
//     try {
//       // Save to /api/offer
//       const endpoint = editingItem ? `/api/offer/${editingItem.id}` : '/api/offer';
...
//         { key: 'title', label: 'Title' },
//         { key: 'description', label: 'Description' },
//         { key: 'imageUrl', label: 'Image', render: (value) => <img src={value} alt="Offer" className="w-24 h-24 object-cover rounded" /> },
...
//             <h3 className="text-xl font-bold mb-4">{editingItem ? 'Edit Offer' : 'Add New Offer'}</h3>
...
//                   <img src={offerImagePreview} alt="Preview" className="w-full h-48 object-contain rounded-md mt-2" />
//                 </div>
//               )}
//               {offerImageUrl && !offerImagePreview && (
//                 <div>
//                   <p className="text-sm text-gray-600">Current Image:</p>
//                   <img src={offerImageUrl} alt="Current" className="w-full h-48 object-contain rounded-md mt-2" />
//                 </div>
//               )}
//               {offerError && <p className="text-red-500 text-sm">{offerError}</p>}
//               {offerSuccess && <p className="text-green-500 text-sm">Offer saved successfully!</p>}
              ...
              <div className="p-6 border-t border-gray-200 flex-shrink-0 bg-gray-50">
                <div className="flex justify-end space-x-3">
                  ...
                  <button 
                    type="submit" 
                    disabled={offerUploading} 
                    className="px-4 py-2 bg-gradient-to-r from-blue-600 to-indigo-600 text-white rounded-lg font-semibold hover:from-blue-700 hover:to-indigo-700 disabled:opacity-50 disabled:cursor-not-allowed transition-all"
                  >
                    {offerUploading ? (
